...
laptimes_names['surname'] = np.where(laptimes_names['surname'] == 'R�_ikk̦nen', 'Raikkonen', laptimes_names['surname'])
laptimes_names['surname'] = np.where(laptimes_names['surname'] == 'H�_lkenberg', 'Hulkenberg', laptimes_names['surname'])
