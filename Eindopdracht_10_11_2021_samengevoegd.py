...
laptimes_names = laptimes.merge(drivers, how='left', on='driverId').iloc[:,:12]
laptimes_names.head()
...
# Achternamen vervangen met de goede namen
laptime_races_spanje['surname'] = np.where(laptime_races_spanje['surname'] == 'R�_ikk̦nen', 'Raikkonen', laptime_races_spanje['surname'])
laptime_races_spanje['surname'] = np.where(laptime_races_spanje['surname'] == 'H�_lkenberg', 'Hulkenberg', laptime_races_spanje['surname'])
