...
streamlit run C:\Users\fleur\anaconda3\lib\site-packages\ipykernel_launcher.py [ARGUMENTS]
...
fig = px.histogram(laptimes_spanje_2016, x='seconds',
                   nbins=500,
                   range_x=['85', '100'],
...
results_test.sort_values('raceId')
results_test
