...
with col4:
    ...
    st.write('Per ronde die een coureur rijdt gaat de rondetijd met 0.03 seconden naar beneden.'
             'Het model het een R-squared van 0.140. Dit betekent dat het model voor 14% goed kan voorspellen.'
             'Dit is een redelijk laag getal, waarschijnlijk komt dit omdat we het voor alle coureurs hebben gedaan' 
             'en niet alle coureurs dezelfde trend hebben.' 
             'De P-waardes van de coëfficienenten zijn nul dat betekent dat er een statistisch significant verschil is. De gevonden coëfficienten zijn niet met toeval gevonden.')
